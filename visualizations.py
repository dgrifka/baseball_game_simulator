...
def create_estimated_bases_table(df, away_team, home_team, away_score, home_score, away_win_percentage, home_win_percentage, images_dir):
    ...
    fig, ax = plt.subplots(figsize=(16, 5))  # Reduced figure height
    ...
    for (row, col), cell in table.get_celld().items():
        ...
        cell.set_height(0.06)  # Reduced cell height
    ...
    fig.text(0.5, 0.95, 'Data: MLB    By: @mlb_simulator', fontsize=19, color='darkgray', ha='center', va='center')
