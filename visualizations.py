...
def la_ev_graph(home_outcomes, away_outcomes, away_estimated_total_bases, home_estimated_total_bases, home_team, away_team, home_score, away_score, home_win_percentage, away_win_percentage, tie_percentage, images_dir = "images"):
    ...
    ## Add watermark
    plt.text(-.05, -.1, 'Data: MLB', transform=plt.gca().transAxes, fontsize=7, color='darkgray', ha='center', va='bottom')
    plt.text(-.05, -.12, 'By: @mlb_simulator', transform=plt.gca().transAxes, fontsize=7, color='darkgray', ha='center', va='bottom')
...
def run_dist(num_simulations, home_runs_scored, away_runs_scored, home_team, away_team, home_score, away_score, home_win_percentage, away_win_percentage, tie_percentage, images_dir = "images"):
    ...
    ## Add watermark
    plt.text(0, -.1, 'Data: MLB', transform=plt.gca().transAxes, fontsize=7, color='darkgray', ha='center', va='bottom')
    plt.text(0, -.12, 'By: @mlb_simulator', transform=plt.gca().transAxes, fontsize=7, color='darkgray', ha='center', va='bottom')
...
def create_estimated_bases_graph(df, title, away_team, home_team, away_score, home_score, away_win_percentage, home_win_percentage, images_dir):
    ...
    ## Add watermark
    ax_graph.text(0.475, 0.01, 'Data: MLB', transform=plt.gca().transAxes, fontsize=10, color='darkgray', ha='center', va='bottom')
    ax_graph.text(0.525, 0.01, 'By: @mlb_simulator', transform=plt.gca().transAxes, fontsize=10, color='darkgray', ha='center', va='bottom')
