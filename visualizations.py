...
def create_estimated_bases_table(df, away_team, home_team, away_score, home_score, away_win_percentage, home_win_percentage, images_dir):
    ...
    for (row, col), cell in table.get_celld().items():
        ...
        cell.set_height(0.04)  # Reduced cell height
    ...
    fig.text(0.5, 1.02, 'Data: MLB    By: @mlb_simulator', fontsize=20, color='darkgray', ha='center', va='center')
